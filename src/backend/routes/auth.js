...
router.get('/health', async (req, res) => {
  try {
    const dbState = require('mongoose').connection.readyState; // 1 connected, 2 connecting
...
router.post('/register', [
  ...
  try {
    ...
    const { name: validName, email: validEmail, password: validPassword, role: validRole = 'user' } = req.body;
    ...
    await user.save();
    console.log('Register success for:', validEmail);
